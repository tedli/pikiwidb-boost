...
#define BOOST_PP_FOR_257(s, p, o, m)                                           \
  BOOST_PP_IIF(BOOST_PP_FOR_257_PR(s, p), BOOST_PP_FOR_257_ERROR,              \
               BOOST_PP_EMPTY)                                                 \
  () /**/
...
#define BOOST_PP_FOR                                                           \
  BOOST_PP_CAT(BOOST_PP_FOR_,                                                  \
               BOOST_PP_DEC(BOOST_PP_AUTO_REC(BOOST_PP_FOR_P, 256)))
#elif BOOST_PP_LIMIT_FOR == 512
#define BOOST_PP_FOR                                                           \
  BOOST_PP_CAT(BOOST_PP_FOR_,                                                  \
               BOOST_PP_DEC(BOOST_PP_AUTO_REC(BOOST_PP_FOR_P, 512)))
#elif BOOST_PP_LIMIT_FOR == 1024
#define BOOST_PP_FOR                                                           \
  BOOST_PP_CAT(BOOST_PP_FOR_,                                                  \
               BOOST_PP_DEC(BOOST_PP_AUTO_REC(BOOST_PP_FOR_P, 1024)))
#else
#error Incorrect value for the BOOST_PP_LIMIT_FOR limit
#endif
#
#define BOOST_PP_FOR_P(n) BOOST_PP_FOR_P_DEC(BOOST_PP_DEC(n))
#define BOOST_PP_FOR_P_DEC(n)                                                  \
  BOOST_PP_CAT(BOOST_PP_FOR_CHECK_, BOOST_PP_CAT(BOOST_PP_FOR_, n)(            \
                                        1, BOOST_PP_FOR_SR_P,                  \
                                        BOOST_PP_FOR_SR_O, BOOST_PP_FOR_SR_M))
#
#define BOOST_PP_FOR_SR_P(r, s) s
#define BOOST_PP_FOR_SR_O(r, s) 0
#define BOOST_PP_FOR_SR_M(r, s) BOOST_PP_NIL
...
#define BOOST_PP_FOR_513(s, p, o, m)                                           \
  BOOST_PP_IIF(BOOST_PP_FOR_513_PR(s, p), BOOST_PP_FOR_513_ERROR,              \
               BOOST_PP_EMPTY)                                                 \
  () /**/
#
#elif BOOST_PP_LIMIT_FOR == 1024
...
#define BOOST_PP_FOR_1025(s, p, o, m)                                          \
  BOOST_PP_IIF(BOOST_PP_FOR_1025_PR(s, p), BOOST_PP_FOR_1025_ERROR,            \
               BOOST_PP_EMPTY)                                                 \
  () /**/
#
#endif
