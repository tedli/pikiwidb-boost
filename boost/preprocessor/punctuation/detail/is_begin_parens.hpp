...
#define BOOST_PP_DETAIL_IBP_SPLIT(i, ...)                                      \
  BOOST_PP_DETAIL_VD_IBP_CAT(BOOST_PP_DETAIL_IBP_PRIMITIVE_CAT(                \
                                 BOOST_PP_DETAIL_IBP_SPLIT_, i)(__VA_ARGS__),  \
                             BOOST_PP_EMPTY())                                 \
  /**/
...
#define BOOST_PP_DETAIL_IBP_SPLIT(i, ...)                                      \
  BOOST_PP_DETAIL_IBP_PRIMITIVE_CAT(BOOST_PP_DETAIL_IBP_SPLIT_, i)             \
  (__VA_ARGS__) /**/
