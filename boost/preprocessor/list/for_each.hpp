...
#define BOOST_PP_LIST_FOR_EACH_X(macro, data, list)                            \
  BOOST_PP_LIST_FOR_EACH_I(BOOST_PP_LIST_FOR_EACH_O, (macro, data), list)
#endif
#
#if ~BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_EDG()
#define BOOST_PP_LIST_FOR_EACH_O(r, md, i, elem)                               \
  BOOST_PP_LIST_FOR_EACH_O_D(r, BOOST_PP_TUPLE_ELEM(2, 0, md),                 \
                             BOOST_PP_TUPLE_ELEM(2, 1, md), elem)
#else
#define BOOST_PP_LIST_FOR_EACH_O(r, md, i, elem)                               \
  BOOST_PP_LIST_FOR_EACH_O_I(r, BOOST_PP_TUPLE_REM_2 md, elem)
#define BOOST_PP_LIST_FOR_EACH_O_I(r, im, elem)                                \
...
#define BOOST_PP_LIST_FOR_EACH_R_X(r, macro, data, list)                       \
  BOOST_PP_LIST_FOR_EACH_I_R(r, BOOST_PP_LIST_FOR_EACH_O, (macro, data), list)
#endif
#
#endif
