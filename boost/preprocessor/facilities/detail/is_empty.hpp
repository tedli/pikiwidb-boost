...
#define BOOST_PP_DETAIL_IS_EMPTY_PROCESS(param)                                \
  BOOST_PP_IS_BEGIN_PARENS(BOOST_PP_DETAIL_IS_EMPTY_NON_FUNCTION_C param())    \
  /**/
...
#define BOOST_PP_DETAIL_IS_EMPTY_IIF(bit)                                      \
  BOOST_PP_DETAIL_IS_EMPTY_PRIMITIVE_CAT(BOOST_PP_DETAIL_IS_EMPTY_IIF_, bit)
