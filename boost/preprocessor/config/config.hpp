...
#if defined(__GCCXML__) || defined(__WAVE__) ||                                \
    defined(__MWERKS__) && __MWERKS__ >= 0x3200
...
#define BOOST_PP_VARIADICS 1
    ...
    (defined(__INTELLISENSE__) ||                                              \
     ...
     !(defined __EDG__ || defined __GCCXML__ || defined __PATHSCALE__ ||       \
       defined __DMC__ || defined __CODEGEARC__ || defined __BORLANDC__ ||     \
       defined __MWERKS__ || defined __SUNPRO_CC || defined __HP_aCC ||        \
       defined __MRC__ || defined __SC__ || defined __IBMCPP__ ||              \
       defined __PGI)) &&                                                      \
